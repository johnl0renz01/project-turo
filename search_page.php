...
$_SESSION['CurrentPage'] = "search_page.php";
$_SESSION['PreviousLink'] = "search";
...
<body class="bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-blue-700 via-blue-900 to-black">
    <div class="flex flex-col h-screen justify-between">    
        ...
        <main class="bg-[radial-gradient(ellipse_at_bottom,_var(--tw-gradient-stops))] from-blue-700 via-blue-900 to-black ">
            <section class="overflow-hidden text-gray-700 ">
                <div class="container px-1 pt-4 pb-20 mx-auto lg:pt-2 lg:px-2">
                    <!-- breadcrumbs-->
                    ...
                    <div class="max-w-full mb-8">
                        ...
                        <div class="relative">
                            ...
                            <form autocomplete="off" action="search_page.php" method="post">  
                                ...
                                value="<?php if(isset($_POST['SearchTag'])) echo $_POST['SearchTag']; else if (isset($_SESSION['SearchKey'])) echo $_SESSION['SearchKey'];?>">
                                <input type="submit" name="Search" value="Search" id="Search" class="cursor-pointer text-white absolute right-2.5 bottom-2.5 bg-yellow-500 hover:bg-orange-800 focus:ring-4 focus:outline-none focus:ring-orange-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-orange-600 dark:hover:bg-orange-700 dark:focus:ring-orange-800">                    
                            </form>
                        </div>
                    </div>

                    <div id="button-group" class="grid gap-8 lg:grid-cols-2 sm:max-w-sm sm:mx-auto lg:max-w-full px-10">
                    <?php       
                        if (isset($_POST['SearchTag'])) {
                            $_SESSION['SearchKey'] = $_POST['SearchTag'];
                            $Search = trim($_POST['SearchTag']);
                            // Database connection
                            $conn = new mysqli('localhost','root','','turo');
                            ...
                            if (mysqli_num_rows($result) === 0) { ?>
                                ...
                                <br>
                                <br>
                                Your search - <span class="text-white font-semibold"><?php echo $Search;?></span> - did not match any documents.
                                <br>
                                <br>
                                Suggestions:
                                </p>
                                <br>
                                <ul class="list-disc text-gray-300 px-6 -mt-5">
                                    <li>Make sure all words are spelled correctly.</li>
                                    <li>Try different keywords.</li>
                                    <li>Try more general keywords.</li>
                                    <li>Try fewer keywords. </li>
                                    <li>Try singular keywords.</li>
                                </ul>
