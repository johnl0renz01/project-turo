                ...
                <ul>
                    ...
                    <!-- DROPDOWN -->
                        ...
                        <div x-show="dropdownOpen" class="absolute right-8 mt-3 py-2 w-32 bg-gray-100 rounded-md shadow-xl z-20">
                            <a href="#" class="block px-4 py-2 text-sm capitalize text-gray-700 hover:bg-orange-500 hover:text-white">
                            your profile
                            </a>
                            <a href="#" class="block px-4 py-2 text-sm capitalize text-gray-700 hover:bg-orange-500 hover:text-white">
                            Your projects
                ...
                <div class="container px-1 pt-4 pb-10 mx-auto lg:pt-2 lg:px-2">
                    ...
                    <nav class="py-2 rounded-md w-full">
                        <ol class="list-reset flex">
                            <li><a href="_HomePage.html" class="text-orange-400 hover:text-orange-500">Home</a></li>
                    ...
                    <div class="max-w-full mb-8">
                            ...
                            <div class="relative">
                                ...
                                <form action="search_page.php" method="post">  
                                    ...
                                    <input type="submit" value="Search" class="text-white absolute right-2.5 bottom-2.5 bg-yellow-500 hover:bg-orange-800 focus:ring-4 focus:outline-none focus:ring-orange-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-orange-600 dark:hover:bg-orange-700 dark:focus:ring-orange-800">    
                    ...
                    <?php       
                        if (isset($_POST['SearchTag'])) {
                            ...
                            $sql = "SELECT * FROM restaurantsearch WHERE RestaurantName = '$Search' OR CuisineType = '$Search' OR Tags = '$Search'";
                    ...
                    <?php
                                ...
                                $_SESSION['RestaurantImg'] = $row['RestaurantImg'];
                    ...
                    <!--Suggestion 1-->
                        ...
                        <div class="relative block overflow-hidden transition-shadow duration-300 bg-[radial-gradient(ellipse_at_bottom,_var(--tw-gradient-stops))] from-blue-700 via-blue-900 to-black rounded hover:shadow-orange-500 shadow-2xl">
                            ...
                            <img src="<?php echo "./img/"; echo $_SESSION['RestaurantImg']; echo ".jpg";?>"  class="object-cover w-full h-64" alt="" />
                            <div class="p-5"> 
                                <a href="/" aria-label="Category" title="Visit the East" class="inline-block mb-2 text-2xl font-bold leading-5 transition-colors duration-200 text-white hover:text-deep-purple-accent-700">
                                    <?php echo $_SESSION['RestaurantName'];?>
                                </a>
                                <p class="mb-3 text-xs font-semibold tracking-wide uppercase">
                                <a href="/" class="transition-colors duration-200 text-white hover:text-deep-purple-accent-700" aria-label="Category" title="traveling">FOODS</a>
                                <span class="text-gray-200">: <?php echo $_SESSION['CuisineType']; echo ', '; echo $_SESSION['Tags'];?></span>
                                </p>
                                <p class="mb-2 text-white pb-10">
                                <?php echo $_SESSION['Description'];?>
                                </p>
                                <div class="absolute mt-4 bottom-2 border-b border-orange-800  font-medium mb-2">
                        ...
                        <div class="relative block overflow-hidden transition-shadow duration-300 bg-[radial-gradient(ellipse_at_bottom,_var(--tw-gradient-stops))] from-blue-700 via-blue-900 to-black rounded hover:shadow-orange-500 shadow-2xl">
                            ...
                            <img src="https://tummywonderland.com/wp-content/uploads/2016/09/marygrace.jpg?auto=compress&amp;cs=tinysrgb&amp;dpr=2&amp;h=750&amp;w=1260" class="object-cover w-full h-64" alt="" />
                            <div class="p-5"> 
                                <a href="/" aria-label="Category" title="Visit the East" class="inline-block mb-2 text-2xl font-bold leading-5 transition-colors duration-200 text-white hover:text-deep-purple-accent-700">Cafe Mary Grace</a>
                                <p class="mb-3 text-xs font-semibold tracking-wide uppercase">
                                <a href="/" class="transition-colors duration-200 text-white hover:text-deep-purple-accent-700" aria-label="Category" title="traveling">FOODS</a>
                                <span class="text-gray-200">: Filipino, Baked, Savory, Desserts</span>
                                </p>
                                <p class="mb-2 text-white pb-10">
                                Serving Filipino savory comfort food, soft home-baked pastries, and sweet-tooth approved desserts, Cafe Mary Grace is a family-friendly restaurant where you can get homey dishes that everyone in the family will surely love.
                                </p>
                                <div class="absolute mt-4 bottom-2 border-b border-orange-800  font-medium mb-2">
                                    <a href="#" class="text-orange-500">
                                        <p class=" relative group text-xl">
                        ...
                        <div class="relative block overflow-hidden transition-shadow duration-300 bg-[radial-gradient(ellipse_at_bottom,_var(--tw-gradient-stops))] from-blue-700 via-blue-900 to-black rounded hover:shadow-orange-500 shadow-2xl">
                            ...
                            <img src="https://4.bp.blogspot.com/-zxPhfRub9bk/VjJTvfWqvpI/AAAAAAAAMRY/UBS_X4rRz2k/s1600/Kimono%2BKen-2.jpg?auto=compress&amp;cs=tinysrgb&amp;dpr=2&amp;h=750&amp;w=1260" class="object-cover w-full h-64" alt="" />
                            <div class="p-5"> 
                                <a href="/" aria-label="Category" title="Visit the East" class="inline-block mb-2 text-2xl font-bold leading-5 transition-colors duration-200 text-white hover:text-deep-purple-accent-700">Kimono Ken</a>
                                <p class="mb-3 text-xs font-semibold tracking-wide uppercase">
                                <a href="/" class="transition-colors duration-200 text-white hover:text-deep-purple-accent-700" aria-label="Category" title="traveling">FOODS</a>
                                <span class="text-gray-200">: Japanese, Steamed, Boiled, Soup, Raw</span>
                                </p>
                                <p class="mb-2 text-white pb-10">
                                With their mantra "Enticingly Japanese. For Less.", your Japanese food cravings will surely be satisfied when you order at Kimono Ken at a friendly affordable price.
                                </p>
                                <div class="absolute mt-4 bottom-2 border-b border-orange-800  font-medium mb-2">
                                    <a href="#" class="text-orange-500">
                                        <p class=" relative group text-xl">
                        ...
                        <div class="relative block overflow-hidden transition-shadow duration-300 bg-[radial-gradient(ellipse_at_bottom,_var(--tw-gradient-stops))] from-blue-700 via-blue-900 to-black rounded hover:shadow-orange-500 shadow-2xl">
                            ...
                            <img src="https://media-cdn.tripadvisor.com/media/photo-s/0e/f9/30/81/photo0jpg.jpg?auto=compress&amp;cs=tinysrgb&amp;dpr=2&amp;h=750&amp;w=1260" class="object-cover w-full h-64" alt="" />
                            <div class="p-5"> 
                                <a href="/" aria-label="Category" title="Visit the East" class="inline-block mb-2 text-2xl font-bold leading-5 transition-colors duration-200 text-white hover:text-deep-purple-accent-700">Tim Ho Wan</a>
                                <p class="mb-3 text-xs font-semibold tracking-wide uppercase">
                                <a href="/" class="transition-colors duration-200 text-white hover:text-deep-purple-accent-700" aria-label="Category" title="traveling">FOODS</a>
                                <span class="text-gray-200">: Chinese, Steamed, Baked, BBQ</span>
                                </p>
                                <p class="mb-2 text-white pb-10">
                                Tim Ho Wan is the most affordable Michelin stared restaurant from Hong Kong. This humble but globally-recognized franchise serves a number of dim sum items and rice toppings specials, but they are most popular for their baked buns with BBQ pork.
                                </p>
                                <div class="absolute mt-4 bottom-2 border-b border-orange-800  font-medium mb-2">
                                    <a href="#" class="text-orange-500">
                                        <p class=" relative group text-xl">
