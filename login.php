	...
	if (empty($Username)) {
		...
		if (mysqli_num_rows($result) === 1) {
            ...
            if ($row['Username'] === $Username && $row['Password'] === $Password) {
              $_SESSION['count'] = 2; //TO reload restaurant_overview.php on load
  ...
  <div class=" flex items-center justify-center h-screen ">
    ...
    <section class=" bg-[radial-gradient(ellipse_at_bottom,_var(--tw-gradient-stops))] from-blue-700 via-blue-900 to-black p-6 rounded-lg  hover:shadow-orange-700 shadow-2xl">
      ...
      <div class="flex items-center justify-center">
        <form autocomplete="off" action="login.php" method="post" class="w-96">
          ...
          <div class="text-center pt-1 pb-1 rounded-md">
            <input type="submit" value="Login" class="cursor-pointer inline-block w-full px-6 py-2 border-2 border-red-600 text-black font-medium text-xs leading-tight uppercase rounded-lg bg-gradient-to-r from-orange-500 to-yellow-600 hover:from-green-500 hover:to-yellow-500  shadow-xl hover:shadow-orange-400/50 ">
        ...
        <!--Sign Up button-->
          ...
          <a href="signup_page.php" class="inline-block w-full px-6 py-2 border-2 border-red-600 text-black font-medium text-xs leading-tight uppercase rounded-lg bg-gradient-to-r from-orange-500 to-yellow-600 hover:from-red-500 hover:to-yellow-500  shadow-xl hover:shadow-orange-400/50"> Sign up</a>
