    ...
    <main class="absolute top-0 bottom-0 left-0 right-0 m-auto">
        <div class=" flex items-center justify-center h-screen py-4 ">
            ...
            <section class="bg-[radial-gradient(ellipse_at_bottom,_var(--tw-gradient-stops))] from-blue-700 via-blue-900 to-black p-6 rounded-lg  hover:shadow-orange-700 shadow-2xl ">
                <form autocomplete="off" action="signup_page.php" method="post">
                    ...
                    <div>
                            ...
                            <br>
                            <input type="Password" placeholder="Confirm Password" id="ConfirmPassword" name="ConfirmPassword" required class="border-2 border-gray-400 rounded-md mb-2 w-full px-4 py-1.5"
                ...
                >
                    ...
                    <div class="flex justify-evenly text-lg mb-5 pb-3" >
                        ...
                        <input class="radiobutton" type="radio" name="Gender" required value="m" id="Male"> Male
                        </div>
                        <div class="border-gray-400 border-2 bg-white  text-center py-1 px-8  rounded-md">
                        <input class="radiobutton" type="radio" name="Gender" required value="f" id="Female"> Female 
                        </div>           
                    </div>
                    <!-- GENDER SECTION ENDS -->
                    <hr>
