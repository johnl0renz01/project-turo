                ...
                <div class="container px-1 pt-4 pb-10 mx-auto lg:pt-2 lg:px-2">
                    ...
                    <!--Suggestion 1-->
                        ...
                        <div class="relative block overflow-hidden transition-shadow duration-300 bg-[radial-gradient(ellipse_at_bottom,_var(--tw-gradient-stops))] from-blue-700 via-blue-900 to-black rounded hover:shadow-orange-500 shadow-2xl">
                            ...
                            <img src="<?php echo "./img/"; echo $_SESSION['RestaurantImg']; echo "_MAIN.jpg";?>"  class="object-cover w-full h-64" alt="" />
                            <div class="p-5"> 
                                <form action="restaurant_overview.php" method="post">
                                <input class="hidden" type="text" name="<?php echo $_SESSION['RestaurantImg'];?>" id="<?php echo $_SESSION['RestaurantImg'];?>" value="<?php echo $_SESSION['RestaurantImg'];?>">
                                ...
                                <div class="absolute mt-4 bottom-2 border-b border-orange-800 text-orange-500 font-medium mb-2 ">
                                    ...
                                    <input type="submit" class="cursor-pointer" value="Find out more">
...
<?php 
    ...
    $var = $_SESSION["RestaurantImg"];
    if(isset($_SESSION["RestaurantImg"])) {
        echo '<script>alert("HATDOG KAA.")</script>';
        $RestaurantID = $_SESSION["RestaurantImg"];
        echo "<h2>" . $RestaurantID . "</h2>";
    }
